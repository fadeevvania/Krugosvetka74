            ...
            <div className="Reviews_container">
                ...
                <div className="second">
                    <div className="review">
                        <img src={Elena} alt="" />
                        <h2>Елена</h2>
                        <p>Большое спасибо Свет lorem лане и Татьяне за чудесные поездки, эмоции! Замечательная организация тура. Самое лучшее место — это прекрасные пейзажи, чистейший воздух, покой и умиротворение.</p>
                    </div>
                </div>
                <div className="third">
                    <div className="review">
